...
@section('title', 'Grafik Data Hujan')

@section('content')
<div class="container mx-auto p-8">
    <h1 class="text-4xl font-semibold text-center mb-8">Grafik Data Sensor (Hujan, Temperatur, Kelembapan)</h1>
    ...
    <div class="bg-white shadow-lg rounded-lg p-6">
        <svg viewBox="0 0 700 500" xmlns="http://www.w3.org/2000/svg">
            ...
            <polyline
                ...
                stroke-width="2"
                points="
                    @foreach ($hujan as $index => $rain)
                        {{ 50 + $index * 30 }},{{ 450 - ($rain / 100 * 400) }}
                    @endforeach
                "
            />
            ...
            <!-- Titik Data: Hujan -->
            @foreach ($hujan as $index => $rain)
                <circle cx="{{ 50 + $index * 30 }}" cy="{{ 450 - ($rain / 100 * 400) }}" r="3" fill="#8bc34a" />
            @endforeach
    ...
    <div class="mt-6 bg-gray-100 rounded-lg p-4">
        ...
        <ul class="list-disc pl-6">
            <li><span class="text-red-500 font-bold">Merah:</span> Data suhu (temperature) dari sensor.</li>
            <li><span class="text-blue-500 font-bold">Biru:</span> Data kelembapan (humidity) dari sensor.</li>
            <li><span class="text-green-500 font-bold">Hijau:</span> Data hujan (rain) dari sensor.</li>
